...
- Plugin logo replaced with the current brand app icon from the [media kit](https://www.zenrows.com/media). The previous `assets/logo.png` was a superseded mark that appears nowhere in the brand asset set.
